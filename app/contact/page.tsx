    ...
    <DashboardLayout>
      <div className="flex-1 lg:flex md:px-4 items-center w-full h-[90%] xl:px-14">
        <div className="w-full xl:w-7/12 mt-20 xl:mt-0 flex flex-col gap-4 ">
          ...
          <span
            className={`text-6xl xl:text-9xl text-zinc-950 font-bold leading-[0.9em] ${bricolageGrotesque.className}`}
          >
            Let's Build Something Sharper.
          </span>
        </div>

        <div className="w-full mt-12 xl:mt-0 xl:w-5/12">
          <div className="border border-zinc-300 W-full left-0 text-sm">
            <div className="px-6">
              <Link
                href="mailto:gusfathur250gmail.com"
                className={`flex items-center group gap-3 py-6 text-zinc-900 border-b transition-colors border-zinc-300 hover:border-zinc-600 ${jetBrainsMono.className}`}
              >
                <Email size={20} />
